...
def merge_images(sections):
    ...
    for image_name in sections.keys():
        ...
        for image_path in sections[image_name]:
            print(image_path)
...
sections["sEc2r1"] = [
    ...
    "tmp_drive_images/sEc2r1/sEc2r1.2.1i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.2i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.3i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.4i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.5i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.6i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.7i.tif",
    "tmp_drive_images/sEc2r1/sEc2r1.2.8i.tif",
]
